	...
	public void onClick(View v) {
		...
		if (v.getId() == R.id.blogin) {
			...
			try {
				...
				if (NetworkHelper.checkNetworkConnection(Main.this)) {
					...
					apiParams.add(new BasicNameValuePair(
							AppProperties.PARAM_EMAIL, email));
					result = (new JSONTask(AppProperties.URL,
							AppProperties.METHOD_GET, apiParams)).execute()
							.get();
					...
					if (last != null) {
						...
						if (last.has(AppProperties.ACK)
							...
							if (error
									.getString(getString(R.string.code))
									.equals(AppProperties.WRONG_CREDENTIAL_CODE)) {
								CommonMethods.ShowInfo(Main.this,
